...
const toBeCaseInsensitive = function toBeCaseInsensitive(received, expected) {
    const pass = received.localeCompare(expected, undefined, { sensitivity: "accent" }) === 0;
...
describe("sortByProp", () => {
    ...
    test("sorts lexicographically", () => {
        expect(util.sortByProp(objs, "word1"))
            .toEqual([obj1, obj8, obj3, obj7, obj6, obj5, obj4, obj2]);
    });
    test("sorts lexicographically in reverse", () => {
        expect(util.sortByProp(objs, "word1", true))
            .toEqual([obj2, obj4, obj5, obj6, obj7, obj3, obj1, obj8]);
    });
    test("sorts numerically", () => {
        expect(util.sortByProp(objs, "num1"))
            .toEqual([obj1, obj2, obj6, obj7, obj8, obj3, obj4, obj5]);
    });
    test("sorts numerically in reverse", () => {
        expect(util.sortByProp(objs, "num1", true))
            .toEqual([obj5, obj4, obj3, obj8, obj7, obj2, obj6, obj1]);
    });
});
...
const indexOf = (string, search, position = 0) => string.indexOf(search, position);
...
describe("objectMap", () => {
    test("maps the object's values through the function", () => {
        ...
        expect(util.objectMap(strings, indexOf, "a")).toEqual({
            string1: -1, string2: 6, string3: 2, string4: -1, string5: 4
        });
    });
});
...
const successfulFetch = jest.fn(() => Promise.resolve({ ok: true, status: 200 }));
const unsuccessfulFetch = jest.fn(() => Promise.resolve({ ok: false, status: 0 }));
