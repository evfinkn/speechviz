...
parser.add_argument(
    ...
    required=True,
    help=(
        "path to input directory of faces + images, should be in data/imagesForEncoding"
    ),
)
parser.add_argument(
    "-d",
...
parser.add_argument(
    ...
    default=0.4,
    help=(
        "Controls how far away points can be from one another to still be a cluster."
        " Too small and all will be considered noise, too large and all will be grouped"
        " as 1 face."
    ),
)
