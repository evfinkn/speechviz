...
var TreeItem = class TreeItem {
     ...
     */
    constructor(id, { parent = null, children = null, text = null, removable = false, renamable = false, moveTo = null, copyTo = null, render = true, assocWith = null } = {}) {
...
var Face  = class Face extends TreeItem {
    ...
    constructor(id, { parent = null, text = null, removable = true, renamable = false, assocWith = null, imagePath = null } = {}) {
        ...
        //const imageLi = htmlToElement(`<li><img src='faceClusters/${imagePath}' alt='Example image of face'/></li>`);
        //nest = this.li.lastElementChild;
